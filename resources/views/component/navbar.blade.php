    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="{{ route('map') }}"><i
                            class="fa-sharp-duotone fa-regular fa-map"></i> Peta</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('tabel') }}"><i class="fa-solid fa-table-list"></i>
                        Tabel</a>
                </li>
